  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground selection:bg-indigo-500/30 overflow-x-hidden">
      ...
      <section 
        ...
        className="min-h-[60vh] flex flex-col justify-center items-center px-6 pt-24 pb-48"
      >
        <div className="max-w-4xl w-full text-center mb-24">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <MagneticButton href="mailto:hello@aurelius.dev" className="w-full sm:w-auto px-12 py-6 rounded-2xl glass text-lg font-medium hover:bg-foreground hover:text-background transition-all duration-500 shadow-xl hover:shadow-indigo-500/10">
                Get in touch
              </MagneticButton>
            </div>
          </motion.div>
        ...
        <footer className="mt-auto pt-12 border-t border-foreground/10 w-full max-w-6xl flex flex-col sm:flex-row justify-between items-center gap-8 text-foreground/50 text-[10px] sm:text-[11px] uppercase tracking-[0.25em] text-center sm:text-left font-medium">
          ...
          <div className="flex items-center gap-6 text-foreground/40">
            {SOCIALS.map((social) => (
              <a 
                key={social.id} 
                href={social.url} 
                className="hover:text-indigo-400 transition-all duration-300 hover:-translate-y-2 active:scale-90"
                target="_blank"
                rel="noopener noreferrer"
                title={social.name}
              >
